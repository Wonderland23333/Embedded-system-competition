...
enum opt_code
{
  ...
  OPT_mmemvec_cost_ = 1256,                  /* -mmemvec-cost= */
  OPT_mmusl = 1257,                          /* -mmusl */
  OPT_msingle_float = 1258,                  /* -msingle-float */
  OPT_msoft_float = 1259,                    /* -msoft-float */
  OPT_mstrict_align = 1260,                  /* -mstrict-align */
  OPT_mtune_ = 1261,                         /* -mtune= */
  OPT_muclibc = 1262,                        /* -muclibc */
  OPT_mvecarg = 1263,                        /* -mvecarg */
  OPT_n = 1264,                              /* -n */
  OPT_no_canonical_prefixes = 1265,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1266,              /* -no-integrated-cpp */
  OPT_no_pie = 1267,                         /* -no-pie */
  OPT_nocpp = 1268,                          /* -nocpp */
  OPT_nodefaultlibs = 1269,                  /* -nodefaultlibs */
  OPT_nophoboslib = 1270,                    /* -nophoboslib */
  OPT_nostartfiles = 1271,                   /* -nostartfiles */
  OPT_nostdinc = 1272,                       /* -nostdinc */
  OPT_nostdinc__ = 1273,                     /* -nostdinc++ */
  OPT_nostdlib = 1274,                       /* -nostdlib */
  OPT_o = 1275,                              /* -o */
  OPT_p = 1276,                              /* -p */
  OPT_pass_exit_codes = 1277,                /* -pass-exit-codes */
  /* OPT_pedantic = 1278, */                 /* -pedantic */
  OPT_pedantic_errors = 1279,                /* -pedantic-errors */
  OPT_pg = 1280,                             /* -pg */
  OPT_pie = 1281,                            /* -pie */
  OPT_pipe = 1282,                           /* -pipe */
  OPT_posix = 1283,                          /* -posix */
  OPT_print_file_name_ = 1284,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1285,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1286,          /* -print-multi-directory */
  OPT_print_multi_lib = 1287,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1288,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1289,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1290,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1291,               /* -print-prog-name= */
  OPT_print_search_dirs = 1292,              /* -print-search-dirs */
  OPT_print_sysroot = 1293,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1294,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1295,                        /* -profile */
  OPT_pthread = 1296,                        /* -pthread */
  OPT_quiet = 1297,                          /* -quiet */
  OPT_r = 1298,                              /* -r */
  OPT_rdynamic = 1299,                       /* -rdynamic */
  OPT_remap = 1300,                          /* -remap */
  OPT_s = 1301,                              /* -s */
  OPT_save_temps = 1302,                     /* -save-temps */
  OPT_save_temps_ = 1303,                    /* -save-temps= */
  OPT_shared = 1304,                         /* -shared */
  OPT_shared_libgcc = 1305,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1306,               /* -shared-libphobos */
  /* OPT_specs = 1307, */                    /* -specs */
  OPT_specs_ = 1308,                         /* -specs= */
  OPT_static = 1309,                         /* -static */
  OPT_static_libasan = 1310,                 /* -static-libasan */
  OPT_static_libgcc = 1311,                  /* -static-libgcc */
  OPT_static_libgfortran = 1312,             /* -static-libgfortran */
  OPT_static_libgo = 1313,                   /* -static-libgo */
  OPT_static_liblsan = 1314,                 /* -static-liblsan */
  OPT_static_libmpx = 1315,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1316,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1317,               /* -static-libphobos */
  OPT_static_libstdc__ = 1318,               /* -static-libstdc++ */
  OPT_static_libtsan = 1319,                 /* -static-libtsan */
  OPT_static_libubsan = 1320,                /* -static-libubsan */
  OPT_static_pie = 1321,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1329,                      /* -std=c++2a */
  OPT_std_c__98 = 1330,                      /* -std=c++98 */
  OPT_std_c11 = 1331,                        /* -std=c11 */
  OPT_std_c17 = 1332,                        /* -std=c17 */
  /* OPT_std_c18 = 1333, */                  /* -std=c18 */
  /* OPT_std_c1x = 1334, */                  /* -std=c1x */
  /* OPT_std_c89 = 1335, */                  /* -std=c89 */
  OPT_std_c90 = 1336,                        /* -std=c90 */
  OPT_std_c99 = 1337,                        /* -std=c99 */
  /* OPT_std_c9x = 1338, */                  /* -std=c9x */
  OPT_std_f2003 = 1339,                      /* -std=f2003 */
  OPT_std_f2008 = 1340,                      /* -std=f2008 */
  OPT_std_f2008ts = 1341,                    /* -std=f2008ts */
  OPT_std_f2018 = 1342,                      /* -std=f2018 */
  OPT_std_f95 = 1343,                        /* -std=f95 */
  OPT_std_gnu = 1344,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1345, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1346, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1347,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1348,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1349,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1350, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1351, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1352,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1353,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1354,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1355,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1356, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1357, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1358, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1359,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1360,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1361, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1362, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1363,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1364, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1365, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1366, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1367, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1368, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1369,                     /* -std=legacy */
  OPT_symbolic = 1370,                       /* -symbolic */
  OPT_t = 1371,                              /* -t */
  OPT_time = 1372,                           /* -time */
  OPT_time_ = 1373,                          /* -time= */
  OPT_tno_android_cc = 1374,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1375,                 /* -tno-android-ld */
  OPT_traditional = 1376,                    /* -traditional */
  OPT_traditional_cpp = 1377,                /* -traditional-cpp */
  OPT_trigraphs = 1378,                      /* -trigraphs */
  OPT_u = 1379,                              /* -u */
  OPT_undef = 1380,                          /* -undef */
  OPT_v = 1381,                              /* -v */
  OPT_version = 1382,                        /* -version */
  OPT_w = 1383,                              /* -w */
  OPT_wrapper = 1384,                        /* -wrapper */
  OPT_x = 1385,                              /* -x */
  OPT_z = 1386,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
